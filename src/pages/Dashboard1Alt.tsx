  ...
  return <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto lg:px-6 py-6 lg:py-8 max-w-7xl px-[20px]">
        ...
        <div className="flex flex-col gap-6 lg:grid lg:grid-cols-[1fr_500px] lg:gap-8 lg:grid-rows-[auto]">
          ...
          <Card className="w-full lg:col-start-2 lg:row-start-1 lg:w-[500px] px-5 pt-2 pb-0 bg-card border-border-subtle shadow-[0_4px_12px_rgba(0,0,0,0.05)] rounded-[24px]">
            <h2 className="text-2xl font-serif font-medium mb-0 text-foreground">
              Upcoming Reminders
            </h2>
