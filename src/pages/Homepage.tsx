      ...
      <div className="max-w-3xl mx-auto px-4 py-8 space-y-8">
        ...
        <div className="space-y-4">
          ...
          <Collapsible open={handledExpanded} onOpenChange={setHandledExpanded}>
            <div className={`w-full border-2 border-border duration-300 ease-in-out hover:shadow-lg hover:border-primary/30 ${handledExpanded ? 'rounded-3xl bg-card transition-[background-color,box-shadow]' : 'rounded-full bg-background transition-[border-radius,background-color,box-shadow] delay-200'}`}>
          ...
          {homepage.needsAttention.length > 0 && <Collapsible open={attentionExpanded} onOpenChange={setAttentionExpanded}>
              <div className={`w-full border-2 border-destructive/50 duration-300 ease-in-out hover:shadow-lg hover:border-destructive/70 ${attentionExpanded ? 'rounded-3xl bg-card transition-[background-color,box-shadow]' : 'rounded-full bg-background transition-[border-radius,background-color,box-shadow] delay-200'}`}>
                <CollapsibleTrigger asChild>
          ...
          {homepage.upcomingAnnouncements.length > 0 && <Collapsible open={announcementsExpanded} onOpenChange={setAnnouncementsExpanded}>
              <div className={`w-full border-2 border-border duration-300 ease-in-out hover:shadow-lg hover:border-primary/30 ${announcementsExpanded ? 'rounded-3xl bg-card transition-[background-color,box-shadow]' : 'rounded-full bg-background transition-[border-radius,background-color,box-shadow] delay-200'}`}>
                <CollapsibleTrigger asChild>
                  <button className="w-full p-6 text-center transition-all hover:border-primary/50">
                    <div className="flex items-center justify-between">
                      <span className="flex-1 text-xl font-semibold text-foreground">
