...
export default function Dashboard() {
  ...
  return <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 md:px-6 py-6 md:py-8 max-w-7xl">
        ...
        {/* Main Content Grid */}
        <div className="flex flex-col gap-6 md:grid md:grid-cols-[1.2fr_0.8fr_auto] md:gap-4 md:grid-rows-[auto]">
          ...
          <Card className="w-full md:col-start-2 md:row-start-1 p-5 bg-card border-border-subtle shadow-[0_4px_12px_rgba(0,0,0,0.05)] rounded-[24px] md:w-auto md:max-w-[75%]">
